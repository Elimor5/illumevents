          ...
          <img className ="homepage-events-img" src={event.image_url} />
            <div className="homepage-event-date-time">
              ...
              <span className= "home-event-title ">{event.title} </span>
                ...
                <button className="bookmark-home-page-item" onClick={toggleBookmark}>
                { (loggedIn && users.bookmarked_events) ? users.bookmarked_events.includes(event.id) ? <i className="fa fa-bookmark" aria-hidden="true"></i> :<i className="fa fa-bookmark-o" aria-hidden="true"></i> : null}
                </button>
      </li>
    </section>

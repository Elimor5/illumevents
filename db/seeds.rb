...
EventTicket.create!([
  {ticket_type: "General Admission", price: 50, event_id: 9, max_quantity: 1000},
  {ticket_type: "Car Owner Entrance", price: 20, event_id: 9, max_quantity: 500},
